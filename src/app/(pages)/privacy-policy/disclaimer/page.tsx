const DisclaimerPage = () => {
  return (
    <div className="prose prose-lg max-w-none">
      <h1 className="text-4xl font-bold tracking-tight text-gray-900">Disclaimer</h1>
      <p className="text-sm text-gray-500">Last updated: April 23, 2025</p>

      <div className="mt-8">
        <h2 className="text-2xl font-bold text-gray-900">Interpretation and Definitions</h2>
        <h3 className="mt-4 text-xl font-bold text-gray-900">Interpretation</h3>
        <p>
          The words of which the initial letter is capitalized have meanings defined under the following conditions. The
          following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
        </p>
        <h3 className="mt-4 text-xl font-bold text-gray-900">Definitions</h3>
        <p>For the purposes of this Disclaimer:</p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Disclaimer)
            refers to Replyquick.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Replyquick, accessible from{' '}
            <a href="https://replyquick.ai" className="text-blue-600 hover:underline">
              replyquick.ai
            </a>
          </li>
        </ul>
      ...
      <div className="mt-8">
        <h2 className="text-2xl font-bold text-gray-900">No Responsibility Disclaimer</h2>
        <p>The information on the Service is provided with the understanding that the Company is not herein engaged in rendering legal, accounting, tax, or other professional advice and services. As such, it should not be used as a substitute for consultation with professional accounting, tax, legal or other competent advisers.</p>
        <p>In no event shall the Company or its suppliers be liable for any special, incidental, indirect, or consequential damages whatsoever arising out of or in connection with your access or use or inability to access or use the Service.</p>
      </div>
      
      <div className="mt-8">
        <h2 className="text-2xl font-bold text-gray-900">"Use at Your Own Risk" Disclaimer</h2>
      ...
      <div className="mt-8">
        ...
        <p>
          By email: <a href="mailto:Replyquick@gmail.com" className="text-blue-600 hover:underline">Replyquick@gmail.com</a>
        </p>
      </div>
    </div>
  );
