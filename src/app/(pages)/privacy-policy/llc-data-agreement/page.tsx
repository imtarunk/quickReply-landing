const LLCDataAgreementPage = () => {
  return (
    <div className="prose prose-lg max-w-none">
      <h1 className="text-4xl font-bold tracking-tight text-gray-900">LLC Data Agreement</h1>
      <p className="text-sm text-gray-500">Last updated: April 23, 2025</p>

      <div className="mt-8">
        <h2 className="text-2xl font-bold text-gray-900">Introduction</h2>
        <p>
          This Data Agreement ("Agreement") is entered into between ReplyQuick LLC ("Company") and the user ("User") of
          our services. This Agreement governs the processing of data in connection with the use of our services.
        </p>
      </div>
      ...
      <div className="mt-8">
        ...
        <h3 className="mt-4 text-xl font-bold text-gray-900">Scope of Processing</h3>
        <p>The Company will process personal data only for the following purposes:</p>
        <ul className="list-disc pl-6 space-y-2">
      ...
      <div className="mt-8">
        ...
        <p>
          The Company implements appropriate technical and organizational measures to ensure a level of security
      ...
      <div className="mt-8">
        ...
        <p>
          The Company may transfer personal data to third parties only when necessary and in compliance with applicable
          data protection laws. Such transfers may include:
        </p>
        <ul className="list-disc pl-6 space-y-2">
      ...
      <div className="mt-8">
        ...
        <p>
          The Company will retain personal data only for as long as necessary to fulfill the purposes for which it was
          collected, including for the purposes of satisfying any legal, accounting, or reporting requirements.
        </p>
      </div>

      <div className="mt-8">
        <h2 className="text-2xl font-bold text-gray-900">Compliance and Cooperation</h2>
      ...
      <div className="mt-8">
        ...
        <p>If you have any questions about this Data Agreement, please contact us:</p>
        <p>
