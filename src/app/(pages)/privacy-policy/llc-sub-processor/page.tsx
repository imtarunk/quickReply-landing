const LLCSubProcessorAgreementPage = () => {
  return (
    <div className="prose prose-lg max-w-none">
      <h1 className="text-4xl font-bold tracking-tight text-gray-900">LLC Sub-Processor Agreement</h1>
      <p className="text-sm text-gray-500">Last updated: April 23, 2025</p>

      <div className="mt-8">
        <h2 className="text-2xl font-bold text-gray-900">Introduction</h2>
        <p>
          This Sub-Processor Agreement ("Agreement") governs the relationship between ReplyQuick LLC ("Company") and its
      ...
      <div className="mt-8">
        <h2 className="text-2xl font-bold text-gray-900">Sub-Processor Obligations</h2>
        <h3 className="mt-4 text-xl font-bold text-gray-900">General Requirements</h3>
        ...
        <h3 className="mt-4 text-xl font-bold text-gray-900">Security Measures</h3>
        <p>Sub-processors must implement appropriate security measures, including:</p>
        <ul className="list-disc pl-6 space-y-2">
      ...
      <div className="mt-8">
        ...
        <p>
          Sub-processors must notify the Company without undue delay after becoming aware of a personal data breach,
          providing:
        </p>
        <ul className="list-disc pl-6 space-y-2">
      ...
      <div className="mt-8">
        ...
        <p>If you have any questions about this Sub-Processor Agreement, please contact us:</p>
        <p>
