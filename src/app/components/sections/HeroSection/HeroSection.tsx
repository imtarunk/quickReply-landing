...
export const HeroSection = ({ id }: props) => {
  ...
  return (
    <section id={id} className="w-full py-20 flex justify-center">
      <div
        ref={sectionRef}
        className="relative max-w-7xl w-full px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-start justify-between gap-16"
      >
        ...
        >
          ...
          >
            <img
              src={bell.src}
              alt="bell"
              className="h-40 w-40 absolute mr-[14%] mb-[16%]"
            />
